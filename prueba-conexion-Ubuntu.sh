...
apt-get -y install telnet nmap net-tools
...
ce=(	"gc1-ce.renata.edu.co" "186.113.12.24" 
	...
	"gc1-ce.uniatlantico.edu.co" "190.14.252.112"
)
...
trace(){
	...
	do
		...
		echo "tracepath para ${i}">> resultados_`hostname`.txt
	        tracepath ${i}>> resultados_`hostname`.txt
		echo "-------------------------------------------------------------------------------">> resultados_`hostname`.txt
	done
